// Type: MemberList_AlphabeticalSort
...
internal class MemberList_AlphabeticalSort : IComparer<MemberInfo>
{
  public virtual int Compare(MemberInfo first, MemberInfo second)
  {
